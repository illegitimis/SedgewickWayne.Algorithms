...
{
    /// <summary>
    /// <see href="https://algs4.cs.princeton.edu/41graph/BreadthFirstPaths.java.html"/>
    ...
    ///  To find a shortest path from s to v, we start at s and check for v among all the vertices that we can reach
    ///  by following one edge, then we check for v among all the vertices that we can reach from s by following two edges, and so forth.
    /// </summary>
    public class BreadthFirstPaths : AbstractFindPath
    {
